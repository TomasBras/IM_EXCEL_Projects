    ...
    public static class ExcelController
    {
        ...
        public static string CalcularMediaTurma()
        {
            try
            {
                ...
                {
                    string formula = BuildAverageFormula(testes, row);
                    sheet.Cells[row, colMedia].Formula = formula;
                    row++;
                }
        ...
        public static string CalcularMediaAluno(string nomeAluno)
        {
            try
            {
                ...
                sheet.Cells[rowAluno, colMedia].Formula = BuildAverageFormula(colTestes, rowAluno);
            ...
            try
            {
                ...
                if (colMedia != -1)
                {
                    ...
                    for (int r = headerRow + 1; r < lastRow; r++)
                    {
                        ...
                        sheet.Cells[r, colMedia].Formula = BuildAverageFormula(colTestes, r);
                    }
                }
        ...
        public static string DestacarApenasAprovados()
        {
            try
            {
                ...
                while (sheet.Cells[row, headerCol].Value != null)
                {
                    ...
                    {
                        sheet.Cells[row, colSit].Value2 = "Aprovado";
                        sheet.Cells[row, colSit].Interior.Color =
